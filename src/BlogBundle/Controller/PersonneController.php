...
use BlogBundle\Entity\Personne;
...
class PersonneController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $personnes = $em->getRepository('BlogBundle:Personne')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('BlogBundle\Form\PersonneType', $personne);
    ...
    {
        $deleteForm = $this->createDeleteForm($personne);
        $editForm = $this->createForm('BlogBundle\Form\PersonneType', $personne);
